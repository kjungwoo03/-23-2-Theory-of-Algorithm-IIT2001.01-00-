...
// function to implement selection sorting algorithm
COMP_EXC_COUNT selectionSort(int array[], int n);
...
int main() {
    ...
    COMP_EXC_COUNT stepCount = selectionSort(data, size);
